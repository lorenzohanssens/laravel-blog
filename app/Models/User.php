 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, Follow> $followers
 * @property-read int|null $followers_count
 * @property-read \Illuminate\Database\Eloquent\Collection<int, Follow> $isFollowing
 * @property-read int|null $is_following_count
