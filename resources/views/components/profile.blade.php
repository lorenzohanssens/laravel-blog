<x-layout :doctitle="$doctitle">
    ...
    @endif
      ...
      <div class="profile-nav nav nav-tabs pt-2 mb-4">
        <a href="/profile/{{$sharedData['username']}}" class="profile-nav-link nav-item nav-link {{Request::segment(3) == "" ? "active" : ""}}">Posts: {{$sharedData['postCount']}}</a> <!-- either pass dynamically but for now too lazy-->
